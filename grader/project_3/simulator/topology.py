...
class Topology:
    ...
    def draw_path(self, source, destination):
        ...
        from simulator.config import __GRADER__LOGGING__FILENAME__
        if correct_length == user_length:
            with open(__GRADER__LOGGING__FILENAME__, "a") as f:
                f.write("correct\n")
    ...
    def draw_tree(self, source):
        ...
        from simulator.config import __GRADER__LOGGING__FILENAME__
        if correct_length_dict == user_length_dict:
            with open(__GRADER__LOGGING__FILENAME__, "a") as f:
                f.write("correct\n")
