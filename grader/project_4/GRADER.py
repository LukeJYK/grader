...
def grade_at(answer_path):
    ...
    ## very important!!!!!!!!!!!!!!!!!!!!!!
    cwd = os.getcwd()
    ending = "/grader/project_4" # TODO: change this line across projects
    ...
    if True: # TODO: (re)?-set this boolean if you want the entire folder or not
    ...
    if os.system("rm -rf %s" % GRADER_TEMP_FOLDER) != 0: # it happens when testing on Moore, strange...
        moore_username = "slo6432" # TODO: change it if yours are different
